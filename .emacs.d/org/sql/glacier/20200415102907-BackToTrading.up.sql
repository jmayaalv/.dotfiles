...
select w.requestid as wfid, 'TRADING' as newstate from ims_workflowrequest w where w.requestid in (57887);
...
--:!1
update ims_premium set locked = false, confirm_date = null, confirmed_by = null where id = 11543;

--:!1
update ims_sbtrade_req set status = 2 where id = 1510;
