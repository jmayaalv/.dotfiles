--:!2
create temp table  tmp_move_wfid_to_state on commit drop as select w.requestid as wfid, 'REJECTED' as newstate from ims_workflowrequest w where requestid in (48234,48235);
--:!2
