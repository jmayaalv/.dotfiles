...
select w.requestid as wfid, 'TRADING' as newstate from ims_workflowrequest w where w.requestid in (53888,52581,51428,53944,51954,51303,51169,52777,51670,52158,53617,51523,53407);
