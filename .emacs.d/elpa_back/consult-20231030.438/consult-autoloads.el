...
Variant of `consult-buffer' which switches to a buffer in another window." t nil)

(autoload 'consult-buffer-other-frame "consult" "\
Variant of `consult-buffer' which switches to a buffer in another frame." t nil)

(autoload 'consult-buffer-other-tab "consult" "\
Variant of `consult-buffer' which switches to a buffer in another tab." t nil)
