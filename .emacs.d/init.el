...
(custom-set-variables
 ...
 '(package-selected-packages
   '(posframe lsp-treemacs swiper marginalia consult-flycheck embark-consult consult embark selectrum-prescient selectrum seletrum imenu-anywhere ivy-prescient hl-todo git-timemachine guru-mode easy-kill diff-hl queue spinner undo-tree lsp-mode eglot html-to-hiccup doom-themes itail logview log4j-mode vlf anzu tuareg ivy-posframe counsel-projectile ivy-rich counsel lsp-java gnu-elpa-keyring-update plantuml-mode eyuml cider-hydra hercules persistent-overlays yaml-mode flycheck-clj-kondo company-quickhelp discover-my-major helm-descbinds restclient ag persp-projectile perspective yasnippet material-theme beacon nord-theme dracula-theme darkula-theme treemacs-projectile treemacs 0blayout ta crux key-chord spaceline airline-themes solarized-theme flycheck-color-mode-line helm-ag eyebrowse iedit expand-region flycheck-joker nyan-mode ssh-tunnels htmlize swiper-helm try org-bullets asana ace-window avy markdown-mode helm-css-scss css-eldoc tagedit orgit zenburn-theme which-key use-package super-save smartscan refheap rainbow-mode rainbow-delimiters ox-reveal neotree magit js2-mode inf-clojure highlight-symbol helm-projectile helm-orgcard git-gutter-fringe+ gist exec-path-from-shell discover company-flx clojure-cheatsheet clj-refactor buffer-move all-the-icons align-cljlet ace-jump-mode))
